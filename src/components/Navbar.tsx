...
export function Navbar({isVisible, setIsVisible}: NavbarProps){
    ...
    return (
        <div className="relative flex justify-center items-center h-20 py-5 z-8 bg-black w-full">
            <div className="fixed lg:sticky top-0 flex justify-between xl:justify-end items-center w-full px-5 xl:px-16">
